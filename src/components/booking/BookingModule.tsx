...
export default function BookingModule() {
 return (
 <div className="w-full max-w-md mx-auto min-h-screen bg-[#f9fafb] pb-24">
 <div className="p-6">
 <h1 className="text-2xl font-bold text-gray-900 mb-2">Booking & Wallet</h1>
 <p className="text-gray-500 mb-8">Manage your brand deals and earnings.</p>
 ...
 <h2 className="text-xl font-bold text-gray-900 mb-2">Booking Module</h2>
