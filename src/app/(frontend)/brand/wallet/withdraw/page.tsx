  ...
  if (showSuccess) {
    return (
      <div className="h-full bg-white flex flex-col items-center justify-center p-6 relative">
        ...
        <h2 className="text-[#EF4823] font-bold text-xl mt-8 tracking-tight">Withdraw Successful!</h2>
      </div>
    )
  }
        ...
        <div className="flex-1 overflow-y-auto px-6 flex flex-col">
          ...
          <div className="w-full flex flex-col mb-8">
            ...
            <div className="flex gap-3">
              <button onClick={() => setAmount("₹1500")} className="px-4 py-2 border border-[#EF4823] text-[#EF4823] font-bold text-[12px] rounded-full hover:bg-[#FEF5ED]">+₹1500</button>
              <button onClick={() => setAmount("₹5000")} className="px-4 py-2 border border-[#EF4823] text-[#EF4823] font-bold text-[12px] rounded-full hover:bg-[#FEF5ED]">+₹5000</button>
              <button onClick={() => setAmount("₹10000")} className="px-4 py-2 border border-[#EF4823] text-[#EF4823] font-bold text-[12px] rounded-full hover:bg-[#FEF5ED]">+₹10000</button>
            </div>
          </div>
