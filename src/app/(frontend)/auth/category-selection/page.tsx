...
export default function RegisterPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center py-2 lg:py-6 flex-1 min-h-0 relative">
      ...
      {/* Top Header Section */}
      <div className="w-full flex items-center justify-center relative mb-4 lg:mb-2 px-2 pt-6 lg:pt-4">
      ...
      <p className="text-white/95 lg:text-text-light text-[12px] sm:text-[13px] lg:text-sm font-normal mb-3 lg:mb-2 text-center px-4 leading-tight">
      ...
      {/* Yellow Pill */}
      <div className="bg-[#E5DF72] rounded-full px-4 py-1.5 mb-5 lg:mb-3 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-2 lg:gap-6 w-full">
          ...
          <div className="flex flex-col gap-2 lg:gap-6">
            ...
            <div 
              ...
              className="flex flex-col items-center justify-center bg-primary-red rounded-[20px] lg:rounded-[28px] aspect-[4/5] lg:aspect-[6/7] p-2 cursor-pointer hover:scale-[1.02] active:scale-95 transition-all shadow-sm relative overflow-hidden group"
            >
              ...
              <h3 className="text-white text-[20px] sm:text-[22px] lg:text-3xl font-black relative z-10 leading-none mb-0.5">Join</h3>
            ...
            <div 
              ...
              className="bg-white rounded-[20px] lg:rounded-[28px] aspect-[4/5] lg:aspect-square flex flex-col p-2 lg:p-4 items-center justify-center shadow-sm border border-gray-100 cursor-pointer hover:border-gray-300 transition-colors"
            >
          ...
          <div className="flex flex-col gap-2 lg:gap-6">
            ...
            <div 
              onClick={() => handleSelect('creator')}
              className="rounded-[20px] lg:rounded-[28px] overflow-hidden aspect-[4/5] lg:aspect-square relative shadow-sm cursor-pointer hover:opacity-90 transition-opacity"
            >
              <img 
