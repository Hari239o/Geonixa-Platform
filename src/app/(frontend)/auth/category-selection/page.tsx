        ...
        <div className="grid grid-cols-2 gap-2 lg:gap-6 w-full">
          ...
          <div className="flex flex-col gap-2 lg:gap-6">
            ...
            <div 
              ...
              className="flex flex-col items-center justify-center bg-primary-red rounded-[16px] lg:rounded-[28px] aspect-[5/4] lg:aspect-[6/7] p-2 cursor-pointer hover:scale-[1.02] active:scale-95 transition-all shadow-sm relative overflow-hidden group"
            >
              ...
              <h3 className="text-white text-[18px] sm:text-[22px] lg:text-3xl font-black relative z-10 leading-none mb-0.5">Join</h3>
              <p className="text-button-yellow text-[8px] sm:text-[10px] lg:text-[11px] font-bold uppercase tracking-widest relative z-10 mb-0.5">as a</p>
              <p className="text-button-yellow text-[13px] sm:text-[16px] lg:text-lg font-black relative z-10 leading-none">Creator</p>
            </div>

            {/* 2. Brand Logos (White Block) */}
            <div 
              onClick={() => handleSelect('brand')}
              className="bg-white rounded-[16px] lg:rounded-[28px] aspect-[5/4] lg:aspect-square flex flex-col p-2 lg:p-4 items-center justify-center shadow-sm border border-gray-100 cursor-pointer hover:border-gray-300 transition-colors"
            >
              <div className="grid grid-cols-2 gap-1 lg:gap-4 w-full h-full items-center justify-items-center opacity-80">
                <span className="font-serif font-black text-[8px] sm:text-[11px] lg:text-sm tracking-tighter">CHANEL</span>
                <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-7 sm:h-7 lg:w-9 lg:h-9 fill-black"><path d="M24 7.6c-2.8.2-5.4.8-7.7 1.8-4.6 2-7.7 5.1-9 7.8-.5 1.1-.7 2.1-.7 3.1 0 1.2.6 2.1 1.6 2.5 1.5.7 3.5.2 5.5-.8 3.5-1.9 6.8-5.3 9.4-9.6.2-.3.3-.6.5-.9-1.2 1.4-2.6 2.6-4.1 3.7-2.6 1.8-5.2 2.6-7.5 2.2-1.3-.2-2.1-.8-2.5-1.6-.4-.9-.3-1.8.2-2.8 1.1-2.4 3.3-4.8 6.4-6.8 2.3-1.5 4.8-2.6 7.4-3.2.2 0 .4-.1.5-.1z" /></svg>
                <span className="font-black text-red-600 text-[8px] sm:text-[11px] lg:text-sm tracking-tighter">Levi's</span>
                <span className="font-serif text-pink-400 font-bold text-[7px] sm:text-[9px] lg:text-[11px]">PINK</span>
              </div>
            </div>
            ...
            >
              ...
              <h3 className="text-white text-[18px] sm:text-[22px] lg:text-3xl font-black relative z-10 leading-none mb-0.5">Join</h3>
              <p className="text-button-yellow text-[8px] sm:text-[10px] lg:text-[11px] font-bold uppercase tracking-widest relative z-10 mb-0.5">as a</p>
              <p className="text-button-yellow text-[10px] sm:text-[12px] lg:text-[15px] font-black relative z-10 leading-tight text-center mt-0.5">Partners /<br/>Agency</p>
            </div>
          ...
          <div className="flex flex-col gap-2 lg:gap-6">
            ...
            <div 
              onClick={() => handleSelect('creator')}
              className="rounded-[16px] lg:rounded-[28px] overflow-hidden aspect-[5/4] lg:aspect-square relative shadow-sm cursor-pointer hover:opacity-90 transition-opacity"
            >
              <img 
            ...
            >
              ...
              <h3 className="text-white text-[18px] sm:text-[22px] lg:text-3xl font-black relative z-10 leading-none mb-0.5">Join</h3>
              <p className="text-button-yellow text-[8px] sm:text-[10px] lg:text-[11px] font-bold uppercase tracking-widest relative z-10 mb-0.5">as a</p>
              <p className="text-button-yellow text-[13px] sm:text-[16px] lg:text-lg font-black relative z-10 leading-none">Brand</p>
            </div>
