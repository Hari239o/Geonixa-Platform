        ...
        <div className="flex-1 overflow-y-auto no-scrollbar px-6 pb-24 touch-pan-y">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="relative">
              {profilePic ? (
                ...
                <div className="w-24 h-24 rounded-2xl bg-[#EF4423] flex items-center justify-center text-white font-bold text-2xl shadow-sm">
                  LOGO
                </div>
              )}
            </div>
            
            <label className="bg-[#EF4423] hover:bg-[#d63d1c] text-white px-5 py-2 rounded-xl text-sm font-bold cursor-pointer transition-colors active:scale-95 shadow-sm">
              Change
              <input 
                type="file" 
                accept="image/*" 
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-bold text-[#EF4423] uppercase tracking-wide">Agency / Partner Name</label>
              <input 
                type="text" 
                name="name"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-bold text-[#EF4423] uppercase tracking-wide">Bio</label>
              <textarea 
                name="bio"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-bold text-[#EF4423] uppercase tracking-wide">Website</label>
              <input 
                type="url" 
                name="website"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-bold text-[#EF4423] uppercase tracking-wide">Phone</label>
              <input 
                type="tel" 
                name="phone"
